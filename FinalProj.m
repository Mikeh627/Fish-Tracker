...
phatFISH1 = imtophat(FISH1,strel('disk', 200));
% imshow(phatFISH1);

grayPHATFISH1 = rgb2gray(phatFISH1);
correctedFISH1 = imadjust(grayPHATFISH1);
imshow(correctedFISH1);



bw = imbinarize(correctedFISH1);
bw = bwareaopen(bw,50);
% imshow(bw);

idfkFISH = grayPHATFISH1 - bw;
imshow(idfkFISH);
